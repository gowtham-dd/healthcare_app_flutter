...
class PediatricianPage extends StatefulWidget {
  const PediatricianPage({super.key});

  @override
  State<PediatricianPage> createState() => _PediatricianPageState();
}

class _PediatricianPageState extends State<PediatricianPage> {
  List<Doctor> doctors = [
    Doctor(
      name: "Dr. Prabhu ",
